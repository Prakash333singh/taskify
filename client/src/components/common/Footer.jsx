                   ...
                   px-3 cursor-pointer hover:text-richblack-50 transition-all duration-200`}
                    ...
                    <div className="text-center flex flex-col sm:flex-row ">
                        <div className="flex ">
                            ...
                            <Link to='https://github.com/Prakash333singh' target="__blank" className="text-white hover:underline mr-1"
                            >
                                Prakash Singh
                            </Link>
                        </div>
                        <span> © 2024 coderrunner</span>
                    </div>

                    <div className="flex items-center">
                        <a href="https://www.linkedin.com/in/prakash-code-runner/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
                            <ImLinkedin2 size={17} />
                        </a>
                        <a href="https://github.com/Prakash333singh" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
                            <ImGithub size={17} />
                        </a>
                    </div>
